...
input:checked + .switch__toggle {
  -webkit-box-shadow: inset 0 0 0 2px #3385ff;
...
.switch.switch--material.switch--active input:checked + .switch__toggle .switch__handle:before {
  -webkit-box-shadow: 0px 0px 0px 14px rgba(128,203,196,0.2);
  box-shadow: 0px 0px 0px 14px rgba(128,203,196,0.2);
}
...
.range {
  ...
  background-image: -webkit-linear-gradient(#424242, #424242);
  background-image: -moz-linear-gradient(#424242, #424242);
  background-image: -o-linear-gradient(#424242, #424242);
...
.range--material {
  ...
  background-image: -webkit-linear-gradient(#707070, #707070);
  background-image: -moz-linear-gradient(#707070, #707070);
...
.range--material::-webkit-slider-thumb {
  ...
  background-image: -webkit-radial-gradient(7px, circle 6px, #80cbc4 0%, #80cbc4 6px, transparent 7px);
  background-image: radial-gradient(circle 6px at 7px, #80cbc4 0%, #80cbc4 6px, transparent 7px);
  margin-top: -1px;
}
...
.navigation-bar {
  ...
  background-image: -webkit-linear-gradient(90deg, rgba(0,0,0,0), rgba(0,0,0,0) 100%);
  background-image: -moz-linear-gradient(90deg, rgba(0,0,0,0), rgba(0,0,0,0) 100%);
  background-image: -o-linear-gradient(90deg, rgba(0,0,0,0), rgba(0,0,0,0) 100%);
...
.bottom-bar {
  ...
  background-image: -webkit-linear-gradient(270deg, rgba(0,0,0,0), rgba(0,0,0,0) 100%);
  background-image: -moz-linear-gradient(270deg, rgba(0,0,0,0), rgba(0,0,0,0) 100%);
  background-image: -o-linear-gradient(270deg, rgba(0,0,0,0), rgba(0,0,0,0) 100%);
...
.list__item__center {
  ...
  background-repeat: no-repeat;
  background-position: bottom;
  background-image: -webkit-linear-gradient(90deg, #424242, #424242 100%);
  background-image: -moz-linear-gradient(90deg, #424242, #424242 100%);
  background-image: -o-linear-gradient(90deg, #424242, #424242 100%);
  background-image: linear-gradient(0deg, #424242, #424242 100%);
...
@media (-webkit-min-device-pixel-ratio: 2), (min-resolution: 192dpi) {
  .list__item__center {
    background-image: -webkit-linear-gradient(90deg, #424242, #424242 50%, transparent 50%);
    background-image: -moz-linear-gradient(90deg, #424242, #424242 50%, transparent 50%);
    background-image: -o-linear-gradient(90deg, #424242, #424242 50%, transparent 50%);
    background-image: linear-gradient(0deg, #424242, #424242 50%, transparent 50%);
  }
}
.list__item__right {
  -webkit-box-sizing: border-box;
...
.text-input--material {
  ...
  -webkit-font-smoothing: antialiased;
  color: #fff;
  background-image: -webkit-gradient(linear, left bottom, left top, color-stop(1px, transparent), color-stop(1px, #4c4c4c));
  background-image: -webkit-linear-gradient(bottom, transparent 1px, #4c4c4c 1px);
  background-image: -moz-linear-gradient(bottom, transparent 1px, #4c4c4c 1px);
  background-image: -o-linear-gradient(bottom, transparent 1px, #4c4c4c 1px);
  background-image: linear-gradient(to top, transparent 1px, #4c4c4c 1px);
  -webkit-background-size: 100% 2px;
  background-size: 100% 2px;
  background-repeat: no-repeat;
...
.text-input--material:focus {
  background-image: -webkit-gradient(linear, left top, left bottom, from(#009688), to(#009688)), -webkit-gradient(linear, left bottom, left top, color-stop(1px, transparent), color-stop(1px, #4c4c4c));
  background-image: -webkit-linear-gradient(#009688, #009688), -webkit-linear-gradient(bottom, transparent 1px, #4c4c4c 1px);
  background-image: -moz-linear-gradient(#009688, #009688), -moz-linear-gradient(bottom, transparent 1px, #4c4c4c 1px);
  background-image: -o-linear-gradient(#009688, #009688), -o-linear-gradient(bottom, transparent 1px, #4c4c4c 1px);
  background-image: linear-gradient(#009688, #009688), linear-gradient(to top, transparent 1px, #4c4c4c 1px);
...
.popover__arrow {
  ...
  background-color: transparent;
  background-image: -webkit-linear-gradient(45deg, rgba(0,0,0,NaN), rgba(0,0,0,NaN) 50%, transparent 50%);
  background-image: -moz-linear-gradient(45deg, rgba(0,0,0,NaN), rgba(0,0,0,NaN) 50%, transparent 50%);
  background-image: -o-linear-gradient(45deg, rgba(0,0,0,NaN), rgba(0,0,0,NaN) 50%, transparent 50%);
  background-image: linear-gradient(45deg, rgba(0,0,0,NaN), rgba(0,0,0,NaN) 50%, transparent 50%);
